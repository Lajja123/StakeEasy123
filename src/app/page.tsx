...
const operators = [
  { name: 'ChainUp', id: 23, status: 'Active', performance: '99.02%', fee: '0.0 SSV' },
  { name: 'Lido - Meria', id: 29, status: 'Active', performance: '98.09%', fee: '0.0 SSV' },
  { name: 'Lido - Stakely', id: 30, status: 'Active', performance: '89.85%', fee: '0.0 SSV' },
  { name: 'Lido - Openbitlab', id: 37, status: 'Active', performance: '54.72%', fee: '0.0 SSV' },
];
