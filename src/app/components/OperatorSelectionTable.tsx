...
export default function OperatorSelectionTable() {
  ...
  if (showKeystoreUpload) {
    return (
      <UploadKeystoreData
        goBack={goBackToOperatorSelection}
        operatorsData={selectedOperators}
        totalFee={totalFee}
      />
    );
  }
      ...
      <div className="flex flex-col justify-between">
        ...
        <div className="total-fee">
          ...
          <button
            ...
            disabled={selectedOperators.length !== clusterSize} // Disable button if the required number of operators are not selected
            className={`w-full text-white py-[6px] px-4 rounded-[6px] focus:outline-none focus:ring-1 focus:ring-orange-600 focus:ring-opacity-60 font-bold ${
