...
const StakingInterface: React.FC = () => {
  ...
  return (
    <div className="max-w-lg min-h-fit mx-auto p-6 bg-white shadow-md rounded-lg border-2 border-gray-200">
      <h2 className="text-2xl font-bold mb-4">Select your validator funding period</h2>
      <p className="mb-4">The SSV amount you deposit will determine your validator operational runway. (You can always manage it later by withdrawing or depositing more funds).</p>
      ...
      <button className="mt-6 w-full bg-blue-500 text-white py-2 rounded">Next</button>
    </div>
  );
};
