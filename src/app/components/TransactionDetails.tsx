      ...
      <div className="max-w-2xl mx-auto bg-gray-900 text-white rounded-lg shadow-md">
        <div className="bg-gray-800 text-white p-4 rounded-t-lg">
          ...
          <div
            ...
            className="text-xs flex justify-between items-center gap-2 mt-2 py-4 px-2 bg-gray-900 rounded-[8px]"
          >
            <span>
        ...
        <div className="flex justify-center p-4 gap-4">
          <button className="flex-1 font-bold text-white py-2 px-4 rounded"
          style={{
